    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          *
          */
          VectorXd wp_x(ptsx.size());
          VectorXd wp_y(ptsx.size());
          ...
          VectorXd state(6);
          // Compensate 100 ms latency (predict state in delta t) and
          // transform to car projection
          // X-Axis is pointed in driving direction
          ...
          state << px_state, py_state, psi_state, v_state, cte_state, epsi_state;
          //cout << state << endl;
